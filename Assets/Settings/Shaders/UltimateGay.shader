Shader "Universal Render Pipeline/2D/UltimateGay"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // https://gist.github.com/smakhtin/6417335
            float3 Hue(float H)
            {
                float R = abs(H * 6 - 3) - 1;
                float G = 2 - abs(H * 6 - 2);
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                float4 hsv = RGBtoHSV(main.xyz);
                hsv.x += _Time.x * _GaySpeed;
                hsv.x %= 1;
                main.xyz = HSVtoRGB(hsv.xyz).xyz;
